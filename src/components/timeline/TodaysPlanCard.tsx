          ...
          <AccordionTrigger className="p-6 hover:no-underline">
            <div className='flex justify-between items-center w-full'>
              ...
              <div
                ...
                className={cn(buttonVariants({ variant: 'ghost', size: 'icon' }), "mr-4 shrink-0")}
                onClick={(e) => { e.stopPropagation(); setIsPrefModalOpen(true); }}
                onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.stopPropagation(); setIsPrefModalOpen(true); } }}
              >
